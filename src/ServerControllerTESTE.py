# -*- coding: utf-8 -*-
"""
Created on Mon Sep 20 21:10:13 2021
...
def UpdateDataWriteJSON(data):
    ...
    with open('pacientes.json', 'r+', encoding='utf-8') as arq, \
        ...
        if dataSave[0] not in jsonLoad:
            ...
            sortedJSON = OrderedDict(sorted(jsonLoad.items(), key=lambda t: t[0]))
            j.dump(sortedJSON, out, ensure_ascii=False, indent=4, separators=(',',':'))
            jsonLoad = '';
