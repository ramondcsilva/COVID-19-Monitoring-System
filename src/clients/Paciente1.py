...
def client(host = 'localhost', port=8080): 
    ...
    try: 
        while True:
            ...
            message = "1,Nome,Ramon,Idade,20,Temperatura,"+str(valueTemp)+",PressaoArterialMaxima,"+str(valueArte)+",FrequenciaRespiratoria,"+str(valueResp)+",FrequenciaCardiaca,"+str(valueCard)+",SaturacaoSanguinea,"+str(valueSatu)+",Estado,x,Pontuacao,00"
